...
import handlevendorPrint from '../Vendor/VedorVoucher';
...
interface VendorParcelPaymentProps {
    paymentinitialData?: any;
    PaymentId: number | null;
}

const VendorParcelPayment: React.FC<VendorParcelPaymentProps> = ({ paymentinitialData, PaymentId }) => {
...
export default VendorParcelPayment;
