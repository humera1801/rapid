...
interface VendorTicketPaymentProps {
    paymentinitialData?: any;
    PaymentId: number | null;
}

const VendorTicketPayment: React.FC<VendorTicketPaymentProps> = ({ paymentinitialData, PaymentId }) => {
...
export default VendorTicketPayment;
