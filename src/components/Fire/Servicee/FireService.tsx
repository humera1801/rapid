...
const FireService = () => {
    ...
    const onSubmit = async (FormData: any) => {
        ...
        try {
            const response = await axios.post('http://192.168.0.111:3001/service/add_fire_extinguisher_service_type', FormData);
    ...
    const handleEditSubmit = async (FormData: any) => {
        ...
        try {
            ...
            const response = await axios.post('http://192.168.0.111:3001/service/edit_fire_extinguisher_service_type', {
                ...FormData,
