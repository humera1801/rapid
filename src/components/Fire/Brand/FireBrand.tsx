...
const FireBrand = () => {
    ...
    const onSubmit = async (data: FormData) => {
        try {
            const response = await axios.post('http://192.168.0.111:3001/brand/add_new_fire_brand', {
    ...
    const handleEditSubmit = async (data: FormData) => {
        ...
        try {
            ...
            const response = await axios.post('http://192.168.0.111:3001/brand/edit_fire_brand_name', {
