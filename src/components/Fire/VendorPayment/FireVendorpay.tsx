...
interface FireVendorPaymentProps {
    paymentinitialData?: any;
    PaymentId: number | null;
}

const FireVendorPayment: React.FC<FireVendorPaymentProps> = ({ paymentinitialData, PaymentId }) => {
    ...
    const onSubmit: SubmitHandler<FormData> = async (formData) => {
        ...
        const dataToSubmit = {
            ...
            booking_id: ParcelData.febking_id,
...
export default FireVendorPayment;
