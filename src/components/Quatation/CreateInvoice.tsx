        ...
        const fetchData = async () => {
            try {
                ...
                if (q_id) {
                    ...
                    console.log(additionalResponse.data[0]);


                    if (additionalResponse.data[0]?.is_invoice !== 1) {
                        ...
                        if (q_quotation_no) {
                            ...
                            if (response.data && response.data.length > 0) {
                                ...
                                setValue("fedc_challan_no", response.data[0].fedc_challan_no);
                                ...
                                setValue("whatsup_no", response.data[0].fedc_whatsapp_no || '');
                    ...
                    else if (additionalResponse.data[0]?.is_invoice === 1) {
                        const q_quotation_no = additionalResponse.data[0].q_quotation_no;
                        if (q_quotation_no) {
                            ...
                            if (response.data) {
                                ...
                                setWMobileNoValue(response.data[0].whatsapp_no);
                                setValue("ferc_date", response.data[0].ferc_date);
                                setValue("fedc_date", response.data[0].fedc_date);
                            ...
                            const employeeIds = response.data[0].employee_name.split(',').map((id: any) => ({ value: response.data[0].employee_id, label: `${id}` }));
