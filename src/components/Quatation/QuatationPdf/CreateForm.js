...
export const generateQuotationPDF = (formData, bankDetails) => {
    try {
                ...
                <td  colspan="7" style="text-align: left; font-weight: bold;">${festName}</td>
                    ...
                    ${products.map((product, index) => `
                        <tr>
                            ...
                            <td>${product.feqd_quantity} Nos.</td>
                            <td>${product.feqd_rate}</td>
                            <td>Each</td>
                            <td>${product.feqd_amount}</td>
                        </tr>
                    `).join('')}
        ...
        const html = `
            ...
            <body>
                ...
                <table>
                    <tr><td rowspan=8 class="top-align">To, ${formData.client_firstName}<br>${formData.client_address}<br>${formData.client_city} - ${formData.client_state}<br>${formData.client_pincode}</td><td>Quotation No:</td><td>${formData.q_quotation_no}</td></tr>
