                ...
                cell: (row: User) => (
                    <div className='action-buttons'>
                        {userRoles.includes('cabBooking') && (
                            <>
                                <Link href={`/CabBooking/ViewCab?id=${row.cb_id}`} className="btn btn-sm btn-warning">
                                    <FontAwesomeIcon icon={faEye} />
                                </Link>
                                <Link href={`/CabBooking/EditCabBooking?id=${row.cb_id}`} className="btn btn-sm btn-primary">
