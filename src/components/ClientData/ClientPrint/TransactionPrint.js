...
export const generateTransactionPrint = (formData) => {
    try {
...
.account-input:focus {
    ...
    <div class="container">
        ...
        <div class="engaged-by section">Received with thanks from M/s: <span class="underline-text" style="width: 70.2%;">${formData.name}</span>
        </div>
